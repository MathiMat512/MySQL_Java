...
public class Producto {
    ...
    Date fecha_producto;
    String area_producto;
    String disponibilidad_producto;
    int id_area;
    int id_categoria;
    
    public Producto(int id_producto, String nombre_producto, String categoria_producto,String descripcion_producto, int cantidad_producto, Date fecha_producto,
                   String area_producto, String disponibilidad_producto, int id_area,int id_categoria) {
